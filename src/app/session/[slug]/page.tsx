      ...
      <div className="flex flex-col items-center justify-center text-center px-4 h-[30vh] w-full rounded shadow-lg">
        ...
        <div className="flex justify-center space-x-4">
          <a
            ...
            className="flex items-center space-x-2 px-2 bg-green-500 text-white rounded w-[35vw]"
          >
            <svg
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center space-x-2 px-2 bg-blue-500 text-white rounded w-[35vw]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
